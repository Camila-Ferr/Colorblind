...
fundoguia=Sprite(os.path.join(menu_path, 'plano_de_fundo.png'),1)
...
Pergaminho = Sprite(os.path.join(menu_path, 'pergaminnho.png'),1)
...
#Pergaminho.x = janela.width/2 - 303
#Pergaminho.y = janela.height / 2 - 200
