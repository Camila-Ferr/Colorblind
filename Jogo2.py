...
montanha_img = pygame.image.load('Sprites/Background/2.png').convert_alpha()
ceu_img = pygame.image.load('Sprites/Background/3.png').convert_alpha()
...
def desenhar_bg():
    screen.fill(BG)
    for x in range (5):
        screen.blit(ceu_img,((x*ceu_img.get_width())- bg_scroll*0.5 ,0))
        screen.blit(montanha_img,((x*montanha_img.get_width())-bg_scroll * 0.6,SCREEN_HEIGHT-montanha_img.get_height()-300))
        screen.blit(fundo1_img,((x*fundo1_img.get_width())-bg_scroll * 0.7 ,SCREEN_HEIGHT-fundo1_img.get_height()-170))
        screen.blit(fundo2_img, ((x*fundo2_img.get_width())-bg_scroll * 0.8 , SCREEN_HEIGHT - fundo2_img.get_height()-30))
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    #15
                        ...
                        heroi = Personagens('Heroi', x * TILE_SIZE + 230, y * TILE_SIZE, 0.4, 5, 20, 5)
...
while run:
    ...
    if start_game==False:
        ...
        if heroi.vivo:
            ...
            screen_scroll = heroi.mover(moving_left, moving_right)
