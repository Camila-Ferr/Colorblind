...
#carregar músicas
#pygame.mixer.music.load('som/fase1.mp3')
#pygame.mixer.music.load('som/fase2.mp3')
#pygame.mixer.music.set_volume(0.3)
#pygame.mixer.music.play(-1, 0.0, 5000)
#jump_fx = pygame.mixer.Sound('audio/jump.wav')
#jump_fx = pygame.set_volume(0.5)
#morte_fx = pygame.mixer.Sound('audio/morte.wav')
#morte_fx = pygame.set_volume(0.5)
#shot_fx = pygame.mixer.Sound('audio/shot.wav')
#shot_fx = pygame.set_volume(0.5)
#shotmal_fx = pygame.mixer.Sound('audio/shotMal.wav')
#shotmal_fx = pygame.set_volume(0.5)
#grenade_fx = pygame.mixer.Sound('audio/grenade.wav')
#grenade_fx = pygame.set_volume(0.5)
